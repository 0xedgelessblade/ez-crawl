...
<p align="center">
  ...
  <a href="README.md"><img src="https://img.shields.io/badge/📖_中文-README-e67a1e?style=for-the-badge&labelColor=2c2420" alt="中文" /></a>
</p>
...
**Free Tier Friendly** — Built-in strategies to maximize Cloudflare's free plan: resource blocking, URL pattern filtering, caching with `maxAge`, and smart render toggling. Stretch those 10 free minutes to their limit.
...
2. **Poll** — Checks job status every few seconds until Cloudflare finishes discovering and fetching all subpages.
3. **Collect** — Results come back as a single JSON blob. `split-results.py` splits it into individual Markdown files with YAML frontmatter (title, URL, status).
...
```
ez-crawl/
├── README.md                  # 中文版（you are here → English）
